...
const cancel:Action = new Action("cancel");
const undo:Action = new Action("undo");
...
const sphereAction:Action = new Action("sphere", false);
...
function draw(map:sphere.MapWithOffset, 
  player:Entity, 
  variant:number,
